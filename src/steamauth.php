...
{
    echo "<form action=\"logout.php\" method=\"post\"><input value=\"Logout\" type=\"submit\" /></form>"; //logout button
}
...
function steamlogin()
{
    try {
        ...
        if (!$openid->mode) {
            ...
            return "<form action='?login' method='POST'> <button type='submit' class='btn btn-success btn-sm'><i class='fa fa-steam'></i> Log In with Steam</button></form>";
